...
The four hierarchical model fits the data well. Fit indices are strong (CFI = 0.956) residuals are low (RMSEA = 0.091). All laten variables are significant (p-valor < 0.05). are similiar to one another in magnitude (ranging 0.847 - 1.363) 
